...
| :------ | :------ | :------ | :------ | :------ |:------ | :------ |:------ | :------ |:------ | :------ | :------ | :------ |:------ | :------ | :------ |
| **Description** | Identifiant unique de la fv | Strate verticale | Classe | Paysage contextuel | Surface (m²) | Hauteur moyenne (m) | Hauteur médiane (m) | Écart-type de hauteur (m) | Hauteur minimale (q10) (m) | Hauteur maximale (q90) (m) | Pourcentage de couvert persistant (%) | Pourcentage de couvert caduc (%) | Pourcentage de conifères (%) | Pourcentage de feuillus (%) | Type de sol |
