...
12/05:2014 : Bug option découpe sur images ortho format ecw : La liste des fichiers de sortie se cree sur le model de la liste des fichiers selectionnés (contenu dans la zone d'intérêt)
12/05:2014 : Résultat : on écrit bien des fichiers au format GTiff (commme demandé en entrée) mais avec une extension .ecw. Renomme ecw en GTiff rend le fichier lisible.
