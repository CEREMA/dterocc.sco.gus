...
from libs.Lib_postgis import createDatabase, dropDatabase, openConnection, closeConnection, importVectorByOgr2ogr, importRaster, exportVectorByOgr2ogr, executeQuery
    ...
    if col_to_delete_list != []:
       ...
       # Récuperation du driver pour le format shape
        ...
        if data_source is None:
            print(cyan + "statisticsVectorRaster() : " + bold + red + "Impossible d'ouvrir le fichier vecteur : " + vector_file + endC, file=sys.stderr)
