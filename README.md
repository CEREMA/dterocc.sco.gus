...
| **Attribut** | fid | strate | <div style="width: 300000px;">fv</div> | paysage &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | surface | h_moy | h_med | h_et | h_min | h_max | perc_persistant | perc_caduc | perc_conifere | perc_feuillu | type_sol |
| :------ | :------ | :------ | :---------------- | :------------------ |:------ | :------ |:------ | :------ |:------ | :------ | :------ | :------ |:------ | :------ | :------ |
...
| **Valeurs** | int | A: Arboré <br>Au: Arbustif <br>H: Herbacé | AI: Arbre Isolé <br>AA: Alignement d’Arbres <br>BOA: Boisement Arboré <br>AuI: Arbuste Isolé <br>AAu: Alignement d’Arbustes <br>BOAu: Boisement Arbustif <br>PR: Prairie <br>C: Culture <br>PE: Pelouse | 1: urbain <br>2: bord de voirie <br>3: bord de surfaces en eau <br>4: agricole et forestier <br>5: autres milieux naturels | float | float | float | float | float | float | float (0-100) | float (0-100) | float (0-100) | float (0-100) | Surface végétalisée / non végétalisée |
