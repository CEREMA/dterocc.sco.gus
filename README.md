...
| **Valeurs** | int | A:Arboré Au:Arbustif H:Herbacé | AI:Arbre Isolé AA:Alignement d’Arbres BOA:Boisement Arboré AuI:Arbuste Isolé AAu:Alignement d’Arbustes BOAu:Boisement Arbustif PR:Prairie C:Culture PE:Pelouse | 1:urbain <br>2:bord de voirie <br>3:bord de surfaces en eau <br>4:agricole et forestier <br>5:autres milieux naturels | float | float | float | float | float | float | float (0-100) | float (0-100) | float (0-100) | float (0-100) | Surface végétalisée / non végétalisée |
